...
export default class Rectangle {
  ...
  drawPoint(context) {
    ...
    context.fillRect(this.position.offsetX - CONSTANTS.POINT_SIZE / 2, this.position.offsetY - CONSTANTS.POINT_SIZE / 2, CONSTANTS.POINT_SIZE, CONSTANTS.POINT_SIZE);
    context.fillRect(this.position.offsetX + this.position.width - CONSTANTS.POINT_SIZE / 2, this.position.offsetY - CONSTANTS.POINT_SIZE / 2, CONSTANTS.POINT_SIZE, CONSTANTS.POINT_SIZE);
    context.fillRect(this.position.offsetX - CONSTANTS.POINT_SIZE / 2, this.position.offsetY + this.position.height - CONSTANTS.POINT_SIZE / 2, CONSTANTS.POINT_SIZE, CONSTANTS.POINT_SIZE);
    context.fillRect(this.position.offsetX + this.position.width - CONSTANTS.POINT_SIZE / 2, this.position.offsetY + this.position.height - CONSTANTS.POINT_SIZE / 2, CONSTANTS.POINT_SIZE, CONSTANTS.POINT_SIZE);
    context.stroke();
  }
